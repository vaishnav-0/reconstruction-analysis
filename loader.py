# https://github.com/yjg30737/pyqt-translucent-full-loading-screen-thread/blob/main/pyqt_translucent_full_loading_screen_thread/loadingTranslucentScreen.py
...
class LoadingTranslucentScreen(QWidget):
    ...
    def __initUi(self, description_text):
        ...
        loading_screen_ico_filename = os.path.join(caller_path, 'assets/loading.gif')

        self.__loading_mv = QMovie(loading_screen_ico_filename)
        self.__loading_mv.setScaledSize(QSize(45, 45))
        self.__loading_mv.setCacheMode(QMovie.CacheAll)
    ...
    def start(self):
        ...
        # Uncommenting causes gif to freeze
